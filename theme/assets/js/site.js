(function () {
  ...
  if (typeof hljs !== 'undefined') {
    if (typeof hljs.registerAliases === 'function' && typeof hljs.getLanguage === 'function') {
      if (!hljs.getLanguage('dart')) {
        hljs.registerAliases('dart', { languageName: 'java' });
      }
    }
    ...
    document.querySelectorAll('pre code').forEach((block) => {
      ...
      try {
        ...
        console.warn('Highlight failed for block:', err);
      }
    });
  }
